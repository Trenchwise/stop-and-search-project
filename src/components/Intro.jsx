...
const Intro = () => {
  return (
    <div id="introWrapper" className="globalCard">
      <div className="introSentenceOneWrapper">
        <svg
          className="introIcon"
          // width="800px"
          // height="800px"
        ...
        <h3 className="headerSubTitle">
          Check the type and frequency of crime in your area
        </h3>
      </div>
      <div className="introSentenceTwoWrapper">
        ...
        <h3>
          Check stops made by the police. Did they find what they were looking
          for?
        </h3>
      </div>
      {/* <p>
